...
def main(host: str, port: int):
    ...
    skill = AgentSkill(
        ...
        description="Returns a greeting based on the current date, time  and timezone of the day",
        tags=["greeting", "time", "hello"],                # Searchable tags
        examples=["Greet me", "Say hello based on date, time and timezone"]   # Example prompts
    )
    ...
    agent_card = AgentCard(
        ...
        description="Agent that greets you based on the current date, time and timezone",
